...
import { Badge } from "lucide-react" // Using icon as placeholder for badge logic or just styled span
    ...
    >
      ...
      <motion.div variants={itemVariants}>
        <Card className="border-none shadow-sm">
          ...
          <CardContent>
            <DataTable 
              data={transactions.filter(t => activeTab === 'all' || t.type === activeTab)}
              pageSize={5}
              columns={[
                {
                  header: "Activity",
                ...
                },
                {
                  ...
                  accessorKey: (tx) => <span className="font-semibold">{tx.name}</span>
                },
                {
                  header: "Status",
                  accessorKey: (tx) => (
