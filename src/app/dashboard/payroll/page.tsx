                ...
                <Card className="border-none shadow-sm">
                  <CardHeader className="flex flex-row items-center justify-between pb-2">
                    <div className="space-y-1">
                      ...
                      <CardDescription>Choose which freelancers to include in this payroll run.</CardDescription>
                    </div>
                        ...
                        <div key={f.id} className="flex items-center justify-between p-4 hover:bg-accent/30 transition-colors">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground font-mono">{f.wallet}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-4">
                  ...
                  <CardFooter className="bg-accent/5 p-6 flex justify-between">
                    <div>
                      ...
                      <p className="text-lg font-bold">3 Freelancers</p>
                    </div>
                ...
                <Card className="border-none shadow-sm">
                  ...
                  <CardContent className="space-y-6">
                    <div className="p-6 rounded-2xl bg-accent/20 border-2 border-dashed border-primary/20 flex flex-col items-center text-center space-y-4">
                      ...
                      <div>
                        <p className="text-3xl font-extrabold tracking-tight">1,850 {currency}</p>
                        <p className="text-sm text-muted-foreground">Total payout for 3 recipients</p>
                      </div>
                    </div>
                      ...
                      <div className="space-y-2">
                        {freelancers.map(f => (
                          <div key={f.id} className="flex justify-between items-center text-sm py-2 border-b border-border/50">
                            ...
                            <span className="font-mono font-bold">{f.amount} {currency}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <CardFooter className="bg-accent/5 p-6 flex justify-between gap-4">
                    ...
                    <Button size="lg" className="rounded-xl px-10 h-12 shadow-lg shadow-primary/20 bg-green-600 hover:bg-green-700" onClick={() => setStep(3)}>
                      Confirm & Broadcast
                    </Button>
                  </CardFooter>
                </Card>
          ...
          <Card className="border-none shadow-sm">
            ...
            <CardContent className="space-y-4">
              <div className="flex justify-between items-center py-2 border-b text-sm">
                ...
                <span className="font-mono text-xs max-w-[120px] truncate">SP2...X4Y</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b text-sm">
                <span className="text-muted-foreground">Balance</span>
                <span className="font-bold">12,450 STX / 2.5 BTC</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b text-sm">
                <span className="text-muted-foreground">After Payroll</span>
                <span className="font-bold text-primary">10,600 STX / 2.4 BTC</span>
              </div>
            </CardContent>
          </Card>
